...
def main():
    output1_file_path="tests/output_1.txt"
    output2_file_path="tests/output_2.txt"
    output3_file_path="tests/output_3.txt"
    input1_file_path="tests/input_1.txt"
    input2_file_path="tests/input_2.txt"
    input3_file_path="tests/input_3.txt"
    python_cmd="python3"
    ...
    res = run_cmd(python_cmd+" kmeans.py 3 800 3 600 "+input1_file_path)
    if res !=output1:
        print("\t\tError in 1.1")
        tests_passed=False
    res = run_cmd(python_cmd+" kmeans.py 7 430 11 "+ input2_file_path)
    if res !=output2:
        print("\t\tError in 1.2")
        tests_passed=False
    ...
    res = run_cmd(pre_file+"kmeans 3 800 3 600 < "+input1_file_path)
    if res!=output1:
        print("\t\tError in 2.1")
        tests_passed=False
    ...
    res = run_cmd(python_cmd+" kmeans.py 1 5000 5 300 "+input3_file_path)
    if res!=cluster_error:
        print("\t\tError in 3.1")
        tests_passed=False
    ...
    if run_cmd(python_cmd+" kmeans.py 15 5000 5 1000 "+input3_file_path)!=iter_error:
        print("\t\tError in 3.9")
        tests_passed=False
    res = run_cmd(python_cmd+" kmeans.py 15 5000 5 300s "+input3_file_path)
    if res!=iter_error:
        print("\t\tError in 3.10")
        tests_passed=False
    res = run_cmd(python_cmd+" kmeans.py 15 5000 "+input3_file_path)
    if res !=general_error:
        print("\t\tError in 3.11")
        tests_passed=False
    res = run_cmd(python_cmd+" kmeans.py 15 5000 5 300 4 "+input3_file_path)
    if res!=general_error:
        print("\t\tError in 3.12")
        tests_passed=False
    if tests_passed:
